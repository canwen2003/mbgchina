...
abstract class BaseItemDecoration extends RecyclerView.ItemDecoration{
    ...
    BaseItemDecoration(int spanCount, @Px int spacing ){
    ...
    void setPadding(RecyclerView rv, @Px int padding ){
        this.setPadding( rv, padding, padding, padding, padding );
    }
