...
public interface BitmapProcessor {
	 ...
	 * <b>Note:</b> If this processor is used as {DisplayImageOptions.Builder#preProcessor(BitmapProcessor)
	 * pre-processor} then don't forget {Bitmap#recycle() to recycle} incoming bitmap if you return a new
	 * created one.
	 *
