...
public class RoundedImageView extends AppCompatImageView implements ILoadImage{
  ...
  public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    final int tileMode = a.getInt(R.styleable.RoundedImageView_tile_mode, TILE_MODE_UNDEFINED);
    ...
    final int tileModeX =
        a.getInt(R.styleable.RoundedImageView_tile_mode_x, TILE_MODE_UNDEFINED);
    if (tileModeX != TILE_MODE_UNDEFINED) {
      setTileModeX(parseTileMode(tileModeX));
    }

    final int tileModeY =
        a.getInt(R.styleable.RoundedImageView_tile_mode_y, TILE_MODE_UNDEFINED);
  ...
  public void loadImage(String uri) {
    ...
    if (imageLoader!=null) {
      imageLoader.loadImage(uri,DisplayImageOptionsFactory.get().getImageOptions(true),new SimpleImageLoadingListener() {
        @Override
  ...
  public void loadImage(String uri, @NonNull LoadOptions options) {
    ...
    ImageLoader imageLoader=ImageLoader.getInstance();
    if (imageLoader!=null) {
      imageLoader.loadImage(uri, DisplayImageOptionsFactory.get().getImageOptions(options),new SimpleImageLoadingListener() {
        @Override
        public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
          if (loadedImage!=null) {
            setImageBitmap(loadedImage);
