...
public class TextBannerView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mInterval = typedArray.getInteger(R.styleable.TextBannerViewStyle_interval, mInterval);//文字切换时间间隔
        isSingleLine = typedArray.getBoolean(R.styleable.TextBannerViewStyle_isSingleLine, false);//文字是否为单行
        mTextColor = typedArray.getColor(R.styleable.TextBannerViewStyle_textColor, mTextColor);//设置文字颜色
        if (typedArray.hasValue(R.styleable.TextBannerViewStyle_textSize)) {//设置文字尺寸
            mTextSize = (int) typedArray.getDimension(R.styleable.TextBannerViewStyle_textSize, mTextSize);
        ...
        animDuration = typedArray.getInt(R.styleable.TextBannerViewStyle_animDuration, animDuration);//动画时间
        hasSetDirection = typedArray.hasValue(R.styleable.TextBannerViewStyle_direction);
        direction = typedArray.getInt(R.styleable.TextBannerViewStyle_direction, direction);//方向
        if (hasSetDirection) {
            switch (direction) {
        ...
        mFlags = typedArray.getInt(R.styleable.TextBannerViewStyle_flags, mFlags);//字体划线
        switch (mFlags) {
            case STRIKE:
    ...
    public void setDatas(List<String> datas){
        this.mDatas = datas;
        if (StringUtils.notEmpty(mDatas)){
