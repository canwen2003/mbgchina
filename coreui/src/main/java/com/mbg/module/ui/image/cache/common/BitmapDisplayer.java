...
/**
 * Displays { Bitmap} in { com.nostra13.universalimageloader.core.imageaware.ImageAware}. Implementations can
...
public interface BitmapDisplayer {
	/**
	 * Displays bitmap in { com.nostra13.universalimageloader.core.imageaware.ImageAware}.
	 * <b>NOTE:</b> This method is called on UI thread so it's strongly recommended not to do any heavy work in it.
	 *
	 * @param bitmap     Source bitmap
	 * @param imageAware {plain com.nostra13.universalimageloader.core.imageaware.ImageAware Image aware view} to
	 *                   display Bitmap
