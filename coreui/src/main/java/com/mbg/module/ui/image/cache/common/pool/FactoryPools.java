...
/**
 * Provides implementations of { Pool} never return {@code null}, log when new instances are
 * created, and that can use the { com.bumptech.glide.util.pool.FactoryPools.Poolable}
...
public final class FactoryPools {
   ...
   * Pool#acquire()} and that contains objects of the type created by the given { Factory} with
   ...
   * created.
   *
   * @param <T> The type of object that the { List Lists} will contain.
   */
  @NonNull
