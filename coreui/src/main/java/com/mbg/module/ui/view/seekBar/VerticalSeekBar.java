...
import static com.mbg.module.ui.view.seekBar.VerticalRangeSeekBar.DIRECTION_LEFT;
import static com.mbg.module.ui.view.seekBar.VerticalRangeSeekBar.DIRECTION_RIGHT;
import static com.mbg.module.ui.view.seekBar.VerticalRangeSeekBar.TEXT_DIRECTION_VERTICAL;
...
public class VerticalSeekBar extends SeekBar {
    ...
    private void initAttrs(AttributeSet attrs) {
        try {
            ...
            indicatorTextOrientation = t.getInt(R.styleable.VerticalRangeSeekBar_indicator_text_orientation, TEXT_DIRECTION_VERTICAL);
            t.recycle();
        } catch (Exception e) {
            e.printStackTrace();
        }
