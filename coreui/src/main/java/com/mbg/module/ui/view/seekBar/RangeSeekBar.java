...
import static com.mbg.module.ui.view.seekBar.SeekBar.INDICATOR_ALWAYS_HIDE;
import static com.mbg.module.ui.view.seekBar.SeekBar.INDICATOR_ALWAYS_SHOW;
...
public class RangeSeekBar extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        try {
            ...
            seekBarMode = t.getInt(R.styleable.RangeSeekBar_mode, SEEKBAR_MODE_RANGE);
            minProgress = t.getFloat(R.styleable.RangeSeekBar_min, 0);
            maxProgress = t.getFloat(R.styleable.RangeSeekBar_max, 100);
            minInterval = t.getFloat(R.styleable.RangeSeekBar_min_interval, 0);
            gravity = t.getInt(R.styleable.RangeSeekBar_thumbs_gravity, Gravity.TOP);
            progressColor = t.getColor(R.styleable.RangeSeekBar_progress_color, 0xFF4BD962);
            progressRadius = (int) t.getDimension(R.styleable.RangeSeekBar_progress_radius, -1);
            progressDefaultColor = t.getColor(R.styleable.RangeSeekBar_progress_default_color, 0xFFD7D7D7);
            progressDrawableId = t.getResourceId(R.styleable.RangeSeekBar_progress_drawable, 0);
            progressDefaultDrawableId = t.getResourceId(R.styleable.RangeSeekBar_progress_drawable_default, 0);
            progressHeight = (int) t.getDimension(R.styleable.RangeSeekBar_progress_height, Utils.dp2px(getContext(), 2));
            tickMarkMode = t.getInt(R.styleable.RangeSeekBar_tick_mark_mode, TRICK_MARK_MODE_NUMBER);
            tickMarkGravity = t.getInt(R.styleable.RangeSeekBar_tick_mark_gravity, TICK_MARK_GRAVITY_CENTER);
            tickMarkLayoutGravity = t.getInt(R.styleable.RangeSeekBar_tick_mark_layout_gravity, Gravity.TOP);
            tickMarkTextArray = t.getTextArray(R.styleable.RangeSeekBar_tick_mark_text_array);
            tickMarkTextMargin = (int) t.getDimension(R.styleable.RangeSeekBar_tick_mark_text_margin, Utils.dp2px(getContext(), 7));
            tickMarkTextSize = (int) t.getDimension(R.styleable.RangeSeekBar_tick_mark_text_size, Utils.dp2px(getContext(), 12));
