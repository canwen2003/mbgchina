...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorStyle = ta.getInt(R.styleable.SlidingTabLayout_indicator_style, STYLE_NORMAL);
        mIndicatorColor = ta.getColor(R.styleable.SlidingTabLayout_indicator_color, Color.parseColor(mIndicatorStyle == STYLE_BLOCK ? "#4B6A87" : "#ffffff"));
        mTabMarginLeft = ta.getDimension(R.styleable.SlidingTabLayout_tab_margin_left, dp2px(0));
        mTabMarginTop = ta.getDimension(R.styleable.SlidingTabLayout_tab_margin_top, dp2px(mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        mTabMarginRight = ta.getDimension(R.styleable.SlidingTabLayout_tab_margin_right, dp2px(0));
        mTabMarginBottom = ta.getDimension(R.styleable.SlidingTabLayout_tab_margin_bottom, dp2px(mIndicatorStyle == STYLE_BLOCK ? 7 : 0));

        mIndicatorHeight = ta.getDimension(R.styleable.SlidingTabLayout_indicator_height,
                dp2px(mIndicatorStyle == STYLE_TRIANGLE ? 4 : (mIndicatorStyle == STYLE_BLOCK ? -1 : 2)));
        mIndicatorWidth = ta.getDimension(R.styleable.SlidingTabLayout_indicator_width, dp2px(mIndicatorStyle == STYLE_TRIANGLE ? 10 : -1));
        mIndicatorCornerRadius = ta.getDimension(R.styleable.SlidingTabLayout_indicator_corner_radius, dp2px(mIndicatorStyle == STYLE_BLOCK ? -1 : 0));
        mIndicatorMarginLeft = ta.getDimension(R.styleable.SlidingTabLayout_indicator_margin_left, dp2px(0));
        mIndicatorMarginTop = ta.getDimension(R.styleable.SlidingTabLayout_indicator_margin_top, dp2px(mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        mIndicatorMarginRight = ta.getDimension(R.styleable.SlidingTabLayout_indicator_margin_right, dp2px(0));
        mIndicatorMarginBottom = ta.getDimension(R.styleable.SlidingTabLayout_indicator_margin_bottom, dp2px(mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        mIndicatorGravity = ta.getInt(R.styleable.SlidingTabLayout_indicator_gravity, Gravity.BOTTOM);
        mIndicatorWidthEqualTitle = ta.getBoolean(R.styleable.SlidingTabLayout_indicator_width_equal_title, false);

        mUnderlineColor = ta.getColor(R.styleable.SlidingTabLayout_underline_color, Color.parseColor("#ffffff"));
        mUnderlineHeight = ta.getDimension(R.styleable.SlidingTabLayout_underline_height, dp2px(0));
        mUnderlineGravity = ta.getInt(R.styleable.SlidingTabLayout_underline_gravity, Gravity.BOTTOM);

        mDividerColor = ta.getColor(R.styleable.SlidingTabLayout_divider_color, Color.parseColor("#ffffff"));
        ...
        mTabSpaceEqual = ta.getBoolean(R.styleable.SlidingTabLayout_tab_space_equal, false);
        mTabWidth = ta.getDimension(R.styleable.SlidingTabLayout_tab_width, dp2px(-1));
    ...
    public void setTabBackGroundView(OnBackgroundListener onBackGroundListener){
        mTabsBGContainer=onBackGroundListener;
    }
                ...
                tv_tab_title.post(new Runnable() {
                    ...
                    public void run() {
                        if (mTabsBGContainer!=null){
                            View view=mTabsBGContainer.getView(position);
                            if (view!=null){
                                LinearLayout.LayoutParams layoutParams=(LinearLayout.LayoutParams)view.getLayoutParams();
                                RelativeLayout.LayoutParams layoutParams1 = (RelativeLayout.LayoutParams) tv_tab_title.getLayoutParams();
                                layoutParams.width=tv_tab_title.getWidth();
                                layoutParams.height=tv_tab_title.getHeight();
                                layoutParams.leftMargin=layoutParams1.leftMargin;
                                layoutParams.rightMargin=layoutParams1.rightMargin;
