...
public interface Resource<Z> {
   ...
   * android.graphics.drawable.Drawable Drawable}s should only be used by a single {
   * android.view.View View} at a time so each call to this method for Resources that wrap {
   * android.graphics.drawable.Drawable Drawable}s should always return a new {
