 ...
 */
@RestrictTo(LIBRARY)
internal abstract class InflateViewBinding<out VB : ViewBinding>(private val inflateViewBinding: Method) {
    @Suppress("UNCHECKED_CAST")
...
@RestrictTo(LIBRARY)
internal class FullInflateViewBinding<out VB : ViewBinding>(private val inflateViewBinding: Method) : InflateViewBinding<VB>(inflateViewBinding) {
...
@RestrictTo(LIBRARY)
internal class MergeInflateViewBinding<out VB : ViewBinding>(private val inflateViewBinding: Method) : InflateViewBinding<VB>(inflateViewBinding) {
