...
import com.mbg.module.ui.view.itemDecoration.timeline.data.IGridItem;
...
public class GridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void drawTitle(Canvas canvas, int pl, int pr, View child, RecyclerView.LayoutParams params, int pos,RecyclerView parent) {
        ...
        if (isDrawTitleBg) {
            ...
            canvas.drawRect(pl, child.getTop() - params.topMargin - mTitleHeight, parent.getRight()  - parent.getPaddingRight()
