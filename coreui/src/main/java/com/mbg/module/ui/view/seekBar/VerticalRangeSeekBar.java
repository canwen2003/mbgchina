...
public class VerticalRangeSeekBar extends RangeSeekBar {
    ...
    private void initAttrs(AttributeSet attrs) {
        try {
            ...
            orientation = t.getInt(R.styleable.VerticalRangeSeekBar_orientation, DIRECTION_LEFT);
            tickMarkDirection = t.getInt(R.styleable.VerticalRangeSeekBar_tick_mark_orientation, TEXT_DIRECTION_VERTICAL);
            t.recycle();
        } catch (Exception e) {
            e.printStackTrace();
        }
