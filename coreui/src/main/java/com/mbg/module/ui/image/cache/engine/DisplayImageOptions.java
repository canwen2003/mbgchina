 ...
 * <ul>
 * <li>whether stub image will be displayed in { com.nostra13.universalimageloader.core.imageaware.ImageAware
 ...
 * <li>whether { com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view} should be reset
 ...
 * <li>auxiliary object which will be passed to { ImageDownloader#getStream(String, Object) ImageDownloader}</li>
 ...
 * <li>how decoded { Bitmap} will be displayed</li>
 * </ul>
 * <p/>
 ...
 * <li>with { Builder}:<br />
 * <b>i.e.</b> :
 * <code>new { DisplayImageOptions}.Builder().{ Builder#cacheInMemory() cacheInMemory()}.
 * { Builder#showImageOnLoading(int) showImageOnLoading()}.{ Builder#build() build()}</code><br />
 * </li>
 * <li>or by static method: { #createSimple()}</li> <br />
 *
...
public final class DisplayImageOptions {
	...
	public static class Builder {
		...
		/**
		 * Stub image will be displayed in { com.nostra13.universalimageloader.core.imageaware.ImageAware
		...
		/**
		 * Incoming image will be displayed in { com.nostra13.universalimageloader.core.imageaware.ImageAware
		 * image aware view} during image loading
		 *
		...
		/**
		 * Incoming drawable will be displayed in { com.nostra13.universalimageloader.core.imageaware.ImageAware
		 * image aware view} during image loading.
		 * This option will be ignored if { DisplayImageOptions.Builder#showImageOnLoading(int)} is set.
		 */
		 ...
		 * image aware view} if empty URI (null or empty
		 * string) will be passed to <b>ImageLoader.displayImage(...)</b> method.
		 * This option will be ignored if { DisplayImageOptions.Builder#showImageForEmptyUri(int)} is set.
		 */
		 ...
		 * image aware view} if some error occurs during
		 * requested image loading/decoding.
		 * This option will be ignored if { DisplayImageOptions.Builder#showImageOnFail(int)} is set.
		 */
		 ...
		 *
		 * @deprecated Use { #resetViewBeforeLoading(boolean) resetViewBeforeLoading(true)} instead
		 */
		...
		/**
		 * Sets whether { com.nostra13.universalimageloader.core.imageaware.ImageAware
		 * image aware view} will be reset (set <b>null</b>) before image loading start
		 */
		 ...
		 *
		 * @deprecated Use { #cacheInMemory(boolean) cacheInMemory(true)} instead
		 */
		@Deprecated
		 ...
		 *
		 * @deprecated Use { #cacheOnDisk(boolean) cacheOnDisk(true)} instead
		 */
		@Deprecated
		...
		/**
		 * Sets {plain ImageScaleType scale type} for decoding image. This parameter is used while define scale
		 ...
		 * <b>NOTE:</b> { Options#inSampleSize} of incoming options will <b>NOT</b> be considered. Library
		 * calculate the most appropriate sample size itself according yo { #imageScaleType(ImageScaleType)}
		 * options.<br />
		 * <b>NOTE:</b> This option overlaps { #bitmapConfig(Bitmap.Config) bitmapConfig()}
		 * option.
		 */
		 ...
		 * { com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view} but
		...
		/**
		 * Sets custom { BitmapDisplayer displayer} for image loading task. Default value -
		...
		/**
		 * Sets custom {plain Handler handler} for displaying images and firing {plain ImageLoadingListener
		 * listener} events.
		 */
	 ...
	 * <li>{ ImageScaleType#IN_SAMPLE_POWER_OF_2} decoding type will be used</li>
	 * <li>{ Bitmap.Config#ARGB_8888} bitmap config will be used for image decoding</li>
	 * <li>{ SimpleBitmapDisplayer} will be used for image displaying</li>
	 * </ul>
	 * <p/>
