...
//    public static final int PERMISSION_CONTACTS = 3;
    ...
    public static final int PERMISSION_SMS_SEND = 8;

    public static final int PERMISSION_SMS_READ = 9;

    public static final int PERMISSION_STORAGE = 10;

    public static final int PERMISSION_MIC_CAMERA = 11;

    public static final int PERMISSION_LAUNCH = 12;

    public static final int PERMISSION_SETTING = 999;
    ...
    //检查日历权限
    public static void checkCalendar(Object object, PermissionCallbacks callback) {
        requestPermissions(object, callback, PERMISSION_CALENDAR, getCalendarGroup());
    }

    //检查照相权限
    public static void checkCamera(Object object, PermissionCallbacks callback) {
        requestPermissions(object, callback, PERMISSION_CAMERA, Manifest.permission.CAMERA);
    }

    //检查联系人权限
//    public static void checkContact(Object object, PermissionCallbacks callback) {
//        requestPermissions(object, callback, PERMISSION_CONTACTS, getContactsGroup());
//    }

    //检查位置权限
    public static void checkLocation(Object object, PermissionCallbacks callback) {
        requestPermissions(object, callback, PERMISSION_LOCATION, getLocationGroup());
    }

    //检查录音权限
    public static void checkMicroPhone(Object object, PermissionCallbacks callback) {
        requestPermissions(object, callback, PERMISSION_MICROPHONE, Manifest.permission.RECORD_AUDIO);
    }

    //检查电话权限
    public static void checkPhone(Object object, PermissionCallbacks callback) {
        requestPermissions(object, callback, PERMISSION_PHONE, Manifest.permission.READ_PHONE_STATE);
    }

    //检查感应器权限
    public static void checkSensor(Object object, PermissionCallbacks callback) {
        requestPermissions(object, callback, PERMISSION_SENSORS, Manifest.permission.BODY_SENSORS);
    }

    //检查读短信权限
    public static void checkSMSReadPermissson(Object object, PermissionCallbacks callback) {
        requestPermissions(object, callback, PERMISSION_SMS_READ, Manifest.permission.READ_SMS);
    }

    //检查发短信权限
    public static void checkSMSSendPermissson(Object object, PermissionCallbacks callback) {
        requestPermissions(object, callback, PERMISSION_SMS_SEND, Manifest.permission.SEND_SMS);
    }

    //检查读写权限
    public static void checkStoragePermissson(Object object, PermissionCallbacks callback) {
        requestPermissions(object, callback, PERMISSION_STORAGE, getStorageGroup());
    }
    ...
    public static void checkCameraAndMIC(Context context, PermissionCallbacks callback) {
        ...
        requestPermissions(context, callback, PERMISSION_MIC_CAMERA, perms);
    }


    //程序启动需要检查的权限
    public static void checkLaunch(Activity activity, PermissionCallbacks callback) {
        requestPermissions(activity, callback, PERMISSION_LAUNCH, getLaunchGroup());
    }
    ...
    private static String[] getCalendarGroup() {
        String[] perms = null;
