...
public class PermissionHelper {
    ...
    public static List<String> getPermissions() {
        return getPermissions(AppUtils.getPackageName());
    }
    ...
    public static boolean isGrantedWriteSettings() {
        return Settings.System.canWrite(AppUtils.getApplication());
    }
    ...
    public static void requestWriteSettings(final SimpleCallback callback) {
        ...
        PermissionActivity.start(AppUtils.getApplication(), PermissionActivity.TYPE_WRITE_SETTINGS);
    }
    ...
    public static void requestDrawOverlays(final SimpleCallback callback) {
        ...
        PermissionActivity.start(AppUtils.getApplication(), PermissionActivity.TYPE_DRAW_OVERLAYS);
    }
     ...
     */
    public static PermissionHelper permission(@PermissionConsts.Permission final String... permissions) {
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(AppUtils.getApplication(), PermissionActivity.TYPE_RUNTIME);
    }
        ...
        protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            if (byteExtra == TYPE_RUNTIME) {
                if (sInstance == null) {
                    ...
                    Log.e("PermissionHelper", "request permissions failed");
                    finish();
                    return;
                }
