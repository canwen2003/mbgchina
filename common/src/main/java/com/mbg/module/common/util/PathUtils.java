...
public class PathUtils {
    ...
    public static String getInternalAppDataPath() {
        ...
        return getAbsolutePath(AppUtils.getApplication().getDataDir());
    }
    ...
    public static String getInternalAppCodeCacheDir() {
        ...
        return getAbsolutePath(AppUtils.getApplication().getCodeCacheDir());
    }
    ...
    public static String getInternalAppCachePath() {
        return getAbsolutePath(AppUtils.getApplication().getCacheDir());
    }
    ...
    public static String getInternalAppDbPath(String name) {
        return getAbsolutePath(AppUtils.getApplication().getDatabasePath(name));
    }
    ...
    public static String getInternalAppFilesPath() {
        return getAbsolutePath(AppUtils.getApplication().getFilesDir());
    }
    ...
    public static String getInternalAppNoBackupFilesPath() {
        ...
        return getAbsolutePath(AppUtils.getApplication().getNoBackupFilesDir());
    }
    ...
    public static String getExternalAppCachePath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AppUtils.getApplication().getExternalCacheDir());
    }
    ...
    public static String getExternalAppFilesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AppUtils.getApplication().getExternalFilesDir(null));
    }
    ...
    public static String getExternalAppMusicPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_MUSIC));
    }
    ...
    public static String getExternalAppPodcastsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_PODCASTS));
    }
    ...
    public static String getExternalAppRingtonesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_RINGTONES));
    }
    ...
    public static String getExternalAppAlarmsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_ALARMS));
    }
    ...
    public static String getExternalAppNotificationsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_NOTIFICATIONS));
    }
    ...
    public static String getExternalAppPicturesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_PICTURES));
    }
    ...
    public static String getExternalAppMoviesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_MOVIES));
    }
    ...
    public static String getExternalAppDownloadPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS));
    }
    ...
    public static String getExternalAppDcimPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_DCIM));
    }
    ...
    public static String getExternalAppDocumentsPath() {
        if (isExternalStorageDisable()) return "";
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return getAbsolutePath(AppUtils.getApplication().getExternalFilesDir(null)) + "/Documents";
        }
        return getAbsolutePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS));
    }
    ...
    public static String getExternalAppObbPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AppUtils.getApplication().getObbDir());
    }
